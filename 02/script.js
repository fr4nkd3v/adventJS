...
function listGifts(letter) {
  //Quitamos espacios adelante y atras (.trim), reemplazamos posibles dobles espacios por uno solo (.replace), creamos el array dividiendo entre los espacios (.split)
